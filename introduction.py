...
def Intro():
    ...
    time.sleep(1)
    type("'Well this 'rebellion' as you call it simply wants to create more like you so we can win the war against Earth. The gun you stole wasn't loaded. We knew you would assault that guard. You are so predictable.' the woman said. There was a hint of anger in her voice")
    time.sleep(1)
