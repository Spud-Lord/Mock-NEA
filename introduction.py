...
def Intro():
    ...
    time.sleep(1)
    type("You hear faint shouting as you as pulled up and say down on a chair")
    time.sleep(1)
    ...
    time.sleep(2)
    type("'All will be revealed.' said a womans voice")
    time.sleep(1)
    ...
    time.sleep(1)
    type("You manage to make out the slim figure of the dark haired woman and smiled. You look around at the massive room and see two guards holding rifles on either side of you")
    time.sleep(1)
    ...
    time.sleep(1)
    type("She was right... since you lost your job, you have been alone, no job, no family, no home...")
    time.sleep(1)
    ...
    time.sleep(1)
    type("You stands up straight once again. 'Untie 'em' she says. You feel the chains loosen.")
    time.sleep(1)
    ...
    time.sleep(1)
    type("'Put the gun down!' shouted the guard. You don't move as he continues to tell you to put your gun down")
    time.sleep(1)
    type("'As you can see, you are no ordinary human' said the woman")
    time.sleep(1)
    type("'Somewhere is your past, something happened to you that changed your genetic makeup. It made you faster, stronger, smarter. But it also drove you insane.'")
    time.sleep(1)
    ...
    time.sleep(1)
    type("'It will only cost your strength and willpower to relive memories until we find the right one' she walks over to you. 'We want to help you.'")
    time.sleep(1)
    type("You are tempted by this offer... but the name Osbourne still rings a bell...")
    time.sleep(1)
    type("You realise where and immediately react. You raise the gun and point it directly and the other guard and pull the trigger. Nothing...")
    time.sleep(1)
    type("You feel something hit your chest and you fall backwards... never feeling yourself land...")
    time.sleep(2)
    ...
    time.sleep(1)
    type("'This is the machine that will let us access your memories.' the same woman said.")
    time.sleep(1)
    type("'I will not give up my memories to a rebellion!' you protest.")
    time.sleep(1)
    type("'Well this 'rebellion' as you call it simply wants to create more like you so we can win the war against Earth.' the woman said. There was a hint of anger in her voice")
    time.sleep(1)
